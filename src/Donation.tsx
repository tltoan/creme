...
export const fundraiser = {
  goal: 1000,
  paymentUrl: '',
  purpose: 'Help us bring CREME to life.',
};
...
export default function Donation() {
  return <section className="donation" id="support" aria-labelledby="donation-title">
    <div className="donation-copy">
      ...
      <h2 id="donation-title">Help bring CREME<br/><em>to the table.</em></h2>
    ...
    <div className="donation-card">
      ...
      {fundraiser.paymentUrl ? <Button asChild className="donation-button"><a href={fundraiser.paymentUrl} target="_blank" rel="noopener noreferrer">Contribute to CREME <ArrowUpRight size={18}/></a></Button> : <Button className="donation-button" disabled>Donations opening soon</Button>}
